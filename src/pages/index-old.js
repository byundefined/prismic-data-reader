...
// var apiEndpoint = "https://netflix-queue.prismic.io/api/v2"; // TODO: load in prismic-configuration
...
const getData = async () => {
  const podcastData = await client.query(
    prismic.Predicates.at("document.type", "podcast"),
    { pageSize: 100 }
  );
  console.log("what is podcast data", podcastData);
};
                  ...
                  <nav className="mt-5 px-2 space-y-1">
                    {navigation.map((item) => (
                      <a
                        ...
                        href="#"
                        onClick={() => {
                          console.log("make this active", item.name);
